      ...
      <div class="bg-[#1A1A1A] border border-ror-border rounded-2xl p-8 relative overflow-hidden group hover:border-ror-accent/50 transition-colors duration-500">
        ...
        <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
          <div class="space-y-3 flex-1 text-center md:text-left">
            ...
            <p class="text-ror-muted">發布日期：2026-09-01</p>
          </div>
...
const patches = ref([
  {
    ...
    isLatest: true,
    features: [
      { icon: '✨', color: 'text-yellow-400', desc: '<strong>活動圖標資源更新：</strong>更新「雙人同行」九月份活動分頁圖標資源，確保活動介面與紅點正常辨識。' }
    ]
  },
  {
    version: 'v0.5.019',
  ...
  },
  {
    ...
    features: [
      ...
      { icon: '🛠️', color: 'text-red-400', desc: '<strong>交易尋找目標閃退修復：</strong>修復自動交易翻頁與重試時殘留 Native 圖片導致 OOM 崩潰的問題。' },
      { icon: '🔍', color: 'text-gray-400', desc: '<strong>主畫面按鈕檢測修復：</strong>修復交易所按鈕補點檢測名稱異常問題，確保介面加載順暢。' }
    ]
  },
  {
    version: 'v0.5.016',
  ...
  },
  {
    ...
    isLatest: false,
    features: [
      { icon: '🛠️', color: 'text-red-400', desc: '<strong>熱更新修復：</strong>修復熱更新跳轉後目錄指向錯誤，導致更新腳本無法生效的問題。' },
  ...
  },
  {
    ...
    features: [
      ...
      { icon: '📜', color: 'text-yellow-400', desc: '<strong>UI修正：</strong>修正紅月等級選擇下拉框，點擊不到下方等級關卡的BUG。' },
  ...
  },
  {
    ...
    isLatest: false,
    features: [
      { icon: '🌟', color: 'text-yellow-400', desc: '<strong>功能優化：</strong>更新回城時的圖標辨識特徵，並加入備援機制以提升穩定度。' }
    ]
  },
  {
    version: 'v0.5.001',
  ...
  },
  {
    ...
    isLatest: false,
    features: [
      { icon: '⚡', color: 'text-yellow-400', desc: '<strong>彈窗檢測優化：</strong>新增故事劇情對話框的自動跳過支援。' },
      { icon: '🛠️', color: 'text-red-400', desc: '<strong>回城判定修復：</strong>因應遊戲更新，已將回城判讀更新為通用對話框圖標。' },
      { icon: '🎁', color: 'text-purple-400', desc: '<strong>通行證領取修復：</strong>解決因匯出遺漏導致無法自動領取通行證獎勵的問題。' },
      { icon: '✨', color: 'text-blue-400', desc: '<strong>穩定性提升：</strong>改善基礎函數調用，提升整體掛機框架穩定度。' }
    ]
  },
  {
    version: 'v0.4.002',
